  ...
  return (
    <footer className="bg-blue-950 text-white">
      ...
      <div className="px-4 sm:px-6 md:px-8 py-12 sm:py-16 md:py-20 text-center">
        ...
        {/* cta banner */}
        <div className="bg-gray-100 rounded-xl sm:rounded-2xl px-4 sm:px-6 md:px-8 py-4 sm:py-6 max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-800 text-base sm:text-lg font-medium text-center sm:text-left">
            Book an appointment with a licensed therapist today!
          </p>
          <button 
            onClick={() => router.push('/therapists')}
            className="bg-blue-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-medium hover:bg-blue-700 transition-colors whitespace-nowrap w-full sm:w-auto"
          >
            Get in Touch
          </button>
        </div>
      ...
      <div className="border-t border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-12">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 sm:mb-12 gap-6">
            {/* left - logo & nav */}
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 sm:gap-8 md:gap-12 w-full">
              {/* logo */}
          ...
          <div className="border-t border-gray-700 pt-6 sm:pt-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 items-start lg:items-center">
              {/* warning msg */}
